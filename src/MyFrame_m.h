...
protected:
  bool operator==(const MyFrame_Base &) = delete;
...
public:
  ...
  virtual const bits &getParity() const;
  virtual bits &getParityForUpdate() { return const_cast<bits &>(const_cast<MyFrame_Base *>(this)->getParity()); }
...
namespace omnetpp
{
  ...
  template <>
  inline MyFrame_Base *fromAnyPtr(any_ptr ptr) { return check_and_cast<MyFrame_Base *>(ptr.get<cObject>()); }
